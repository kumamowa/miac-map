...
function init() {
	...
	myGeoObject1 = new ymaps.GeoObject({
        ...
        geometry: {
            type: "Point",
            coordinates: [44.901838, 40.488586]
        },
            // Свойства.
        properties: {
		hintContent: 'Кошехабльская поликлиника<br/>Взрослое население<br/>ул. Аслана Джаримова, 7',
		balloonContentBody: [
            '<strong>Кошехабльская поликлиника',
			'<br/>',
			'Взрослое население',
			'<br/>',
	...
	myGeoObject2 = new ymaps.GeoObject({
        ...
        geometry: {
            type: "Point",
            coordinates: [44.901877, 40.488078]
        },
            // Свойства.
        properties: {
		hintContent: 'Кошехабльская поликлиника<br/>Детское население<br/>ул. Аслана Джаримова, 7А',
		balloonContentBody: [
            '<strong>Кошехабльская поликлиника',
			'<br/>',
			'Детское население',
			'<br/>',
			'ул. Аслана Джаримова, 7А</strong>',
			'<br/>',
			'<br/>',
			'Обслуживаемое население: 9999',
			'<br/>',
