...
function init() {
	...
	myGeoObject1 = new ymaps.GeoObject({
        ...
        geometry: {
            type: "Point",
            coordinates: [45.141896, 39.578710]
        },
            // Свойства.
        properties: {
		hintContent: 'Красногвардейская поликлиника<br/>Взрослое население<br/>ул. Больничная, 15',
		balloonContentBody: [
            '<strong>Красногвардейская поликлиника',
			'<br/>',
			'Взрослое население',
			'<br/>',
			'ул. Больничная, 15</strong>',
			'<br/>',
			'<br/>',
	...
	myGeoObject2 = new ymaps.GeoObject({
        ...
        geometry: {
            type: "Point",
            coordinates: [45.141757, 39.579112]
        },
            // Свойства.
        properties: {
		hintContent: 'Красногвардейская поликлиника<br/>Детское население<br/>ул. Больничная, 15',
		balloonContentBody: [
            '<strong>Красногвардейская поликлиника',
			'<br/>',
			'Детское население',
